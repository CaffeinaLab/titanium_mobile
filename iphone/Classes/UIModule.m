...
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_BY_CHAR_WRAPPING
{
  return NUMINTEGER(NSLineBreakByCharWrapping);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_BY_CLIPPING
{
  return NUMINTEGER(NSLineBreakByClipping);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_BY_TRUNCATING_HEAD
{
  return NUMINTEGER(NSLineBreakByTruncatingHead);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_BY_TRUNCATING_TAIL
{
  return NUMINTEGER(NSLineBreakByTruncatingTail);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_BY_TRUNCATING_MIDDLE
{
  return NUMINTEGER(NSLineBreakByTruncatingMiddle);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_ALIGNMENT_LEFT {
    return NUMINTEGER(NSTextAlignmentLeft);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_ALIGNMENT_RIGHT {
    return NUMINTEGER(NSTextAlignmentRight);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_ALIGNMENT_CENTER {
    return NUMINTEGER(NSTextAlignmentCenter);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_ALIGNMENT_JUSTIFIED {
    return NUMINTEGER(NSTextAlignmentJustified);
}
-(NSNumber*)ATTRIBUTE_PARAGRAPH_STYLE_ALIGNMENT_NATURAL {
