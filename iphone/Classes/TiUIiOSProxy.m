...
#ifdef USE_TI_UIIOSATTRIBUTEDSTRING
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_FONT, AttributeNameFont, @"UI.iOS.ATTRIBUTE_FONT", @"3.6.0", @"UI.ATTRIBUTE_FONT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_PARAGRAPH_STYLE, AttributeNameParagraphStyle, @"UI.iOS.ATTRIBUTE_PARAGRAPH_STYLE", @"3.6.0", @"UI.ATTRIBUTE_PARAGRAPH_STYLE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_FOREGROUND_COLOR, AttributeNameForegroundColor,@"UI.iOS.ATTRIBUTE_FOREGROUND_COLOR", @"3.6.0", @"UI.ATTRIBUTE_FOREGROUND_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_BACKGROUND_COLOR, AttributeNameBackgroundColor,@"UI.iOS.ATTRIBUTE_BACKGROUND_COLOR", @"3.6.0", @"UI.ATTRIBUTE_BACKGROUND_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_LIGATURE, AttributeNameLigature, @"UI.iOS.ATTRIBUTE_LIGATURE", @"3.6.0", @"UI.ATTRIBUTE_LIGATURE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_KERN, AttributeNameKern, @"UI.iOS.ATTRIBUTE_KERN", @"3.6.0", @"UI.ATTRIBUTE_KERN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_STRIKETHROUGH_STYLE, AttributeNameStrikethroughStyle, @"UI.iOS.ATTRIBUTE_STRIKETHROUGH_STYLE", @"3.6.0", @"UI.ATTRIBUTE_STRIKETHROUGH_STYLE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_UNDERLINES_STYLE, AttributeNameUnderlineStyle, @"UI.iOS.ATTRIBUTE_UNDERLINES_STYLE", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINES_STYLE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_STROKE_COLOR, AttributeNameStrokeColor, @"UI.iOS.ATTRIBUTE_STROKE_COLOR", @"3.6.0", @"UI.ATTRIBUTE_STROKE_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_STROKE_WIDTH, AttributeNameStrokeWidth, @"UI.iOS.ATTRIBUTE_STROKE_WIDTH", @"3.6.0", @"UI.ATTRIBUTE_STROKE_WIDTH");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_SHADOW, AttributeNameShadow, @"UI.iOS.ATTRIBUTE_SHADOW", @"3.6.0", @"UI.ATTRIBUTE_SHADOW");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_VERTICAL_GLYPH_FORM, AttributeNameVerticalGlyphForm, @"UI.iOS.ATTRIBUTE_VERTICAL_GLYPH_FORM", @"3.6.0", @"UI.ATTRIBUTE_VERTICAL_GLYPH_FORM");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_WRITING_DIRECTION, AttributeNameWritingDirection, @"UI.iOS.ATTRIBUTE_WRITING_DIRECTION", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_TEXT_EFFECT, AttributeNameTextEffect, @"UI.iOS.ATTRIBUTE_TEXT_EFFECT", @"3.6.0", @"UI.ATTRIBUTE_TEXT_EFFECT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_ATTACHMENT, AttributeNameAttachment, @"UI.iOS.ATTRIBUTE_ATTACHMENT", @"3.6.0", @"UI.ATTRIBUTE_ATTACHEMENT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_LINK, AttributeNameLink, @"UI.iOS.ATTRIBUTE_LINK", @"3.6.0", @"UI.ATTRIBUTE_LINK");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_BASELINE_OFFSET, AttributeNameBaselineOffset, @"UI.iOS.ATTRIBUTE_BASELINE_OFFSET", @"3.6.0", @"UI.ATTRIBUTE_BASELINE_OFFSET");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_UNDERLINE_COLOR, AttributeNameUnderlineColor, @"UI.iOS.ATTRIBUTE_UNDERLINE_COLOR", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_STRIKETHROUGH_COLOR, AttributeNameStrikethroughColor, @"UI.iOS.ATTRIBUTE_STRIKETHROUGH_COLOR", @"3.6.0", @"UI.ATTRIBUTE_STRIKETHROUGH_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_OBLIQUENESS, AttributeNameObliqueness, @"UI.iOS.ATTRIBUTE_OBLIQUENESS", @"3.6.0", @"UI.ATTRIBUTE_OBLIQUENESS");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ATTRIBUTE_EXPANSION, AttributeNameExpansion, @"UI.iOS.ATTRIBUTE_EXPANSION", @"3.6.0", @"UI.ATTRIBUTE_EXPANSION");

-(NSNumber*)ATTRIBUTE_UNDERLINE_STYLE_NONE
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_STYLE_NONE", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_STYLE_NONE")
    return NUMINTEGER(NSUnderlineStyleNone);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_STYLE_SINGLE
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_STYLE_SINGLE", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_STYLE_SINGLE")
    return NUMINTEGER(NSUnderlineStyleSingle);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_STYLE_THICK
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_STYLE_THICK", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_STYLE_THICK")
    return NUMINTEGER(NSUnderlineStyleThick);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_STYLE_DOUBLE
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_STYLE_DOUBLE", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_STYLE_DOUBLE")
    return NUMINTEGER(NSUnderlineStyleDouble);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_PATTERN_SOLID
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_PATTERN_SOLID", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_PATTERN_SOLID")
    return NUMINTEGER(NSUnderlinePatternSolid);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_PATTERN_DOT
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_PATTERN_DOT", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_PATTERN_DOT")
    return NUMINTEGER(NSUnderlinePatternDot);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_PATTERN_DASH
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_PATTERN_DASH", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_PATTERN_DASH")
    return NUMINTEGER(NSUnderlinePatternDash);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT")
    return NUMINTEGER(NSUnderlinePatternDashDot);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT_DOT
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT_DOT", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_PATTERN_DASH_DOT_DOT")
    return NUMINTEGER(NSUnderlinePatternDashDotDot);
}
-(NSNumber*)ATTRIBUTE_UNDERLINE_BY_WORD
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_UNDERLINE_BY_WORD", @"3.6.0", @"UI.ATTRIBUTE_UNDERLINE_BY_WORD")
    return NUMINTEGER(NSUnderlineByWord);
}
-(NSNumber*)ATTRIBUTE_WRITING_DIRECTION_NATURAL
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_WRITING_DIRECTION_NATURAL", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION_NATURAL")
    return NUMINTEGER(NSWritingDirectionNatural);
}
-(NSNumber*)ATTRIBUTE_WRITING_DIRECTION_LEFT_TO_RIGHT
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_WRITING_DIRECTION_LEFT_TO_RIGHT", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION_LEFT_TO_RIGHT")
    return NUMINTEGER(NSWritingDirectionLeftToRight);
}
-(NSNumber*)ATTRIBUTE_WRITING_DIRECTION_RIGHT_TO_LEFT
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_WRITING_DIRECTION_RIGHT_TO_LEFT", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION_RIGHT_TO_LEFT")
    return NUMINTEGER(NSWritingDirectionRightToLeft);
}
-(NSNumber*)ATTRIBUTE_WRITING_DIRECTION_EMBEDDING
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_WRITING_DIRECTION_EMBEDDING", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION_EMBEDDING")
    return NUMINTEGER(NSTextWritingDirectionEmbedding);
}
-(NSNumber*)ATTRIBUTE_WRITING_DIRECTION_OVERRIDE
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_WRITING_DIRECTION_OVERRIDE", @"3.6.0", @"UI.ATTRIBUTE_WRITING_DIRECTION_OVERRIDE")
    return NUMINTEGER(NSTextWritingDirectionOverride);
}
-(NSString *)ATTRIBUTE_LETTERPRESS_STYLE
{
    DEPRECATED_REPLACED(@"UI.iOS.ATTRIBUTE_LETTERPRESS_STYLE", @"3.6.0", @"UI.ATTRIBUTE_LETTERPRESS_STYLE")
